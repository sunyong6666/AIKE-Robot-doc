...
| --- | --- |
| 1. Press and hold the Power button for 3 seconds to power on the robot.<br/>The robot announces:“ ** Hi, I’m Aike ! I’m ready to learn and have fun with you! ** ” | 2. Place the RFID card horizontally. |
| ![](IMG/Q5.png) |  |
...
| ![](IMG/Q6.gif) |  ![](IMG/Q7.png) |
| --- | --- |
| 1.  Press and hold the Power button for 3 seconds to power on the robot.   | 2. Place a single RFID card horizontally.<br/>**Applicable Cards:** Action Cards (blue), Sound, Dance, and Expression Cards (purple).<br/>**Example:** Forward |
| ![](IMG/Q8.gif) |  |
...
| ![](IMG/Q6.gif) | <!-- 这是一张图片，ocr 内容为： -->
![](IMG/Q10.png) |
| --- | --- |
| 1. Press and hold the Power button for 3 seconds to power on the robot.   | 2. Place multiple RFID cards horizontally and arrange them in sequence to form a logically complete program.<br/>**Example:**<br/>+   Start  →  Forward   →  Happy   → Stop |
| ![](IMG/Q11.gif) | ![](IMG/Q12.gif) |
